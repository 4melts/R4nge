...
GUI::GUI() noexcept
{
    ...
    if (PWSTR pathToFonts; SUCCEEDED(SHGetKnownFolderPath(FOLDERID_Fonts, 0, nullptr, &pathToFonts))) {
        ...
        fonts.weaponIcons = io.Fonts->AddFontFromFileTTF((path / "undefeated.ttf").string().c_str(), 15.0f, &cfg, Helpers::getFontGlyphRanges());
...
void GUI::renderStreamProofESPWindow(bool contentOnly) noexcept
{
    ...
    ImGui::Combo("Weapon Text", &config->streamProofESP.weaponText, "Text\0Icons\0");
